...
const Sidebar = ({ isMenuOpen, setIsMenuOpen }) => {
  const { chats, setSelectedChat, theme, setTheme, user, navigate, createNewChat, axios, setChats, fetchUserChats, token, setToken } =
    useAppContext();
  ...
  return (
    ...
    >
      ...
      <button onClick={createNewChat}
        className="flex justify-center items-center w-full py-2 mt-10 text-white bg-gradient-to-r from-[#A456F7] 
      ...
      >
        ...
        <div className="flex flex-col text-sm">
          ...
          <p className="text-xs text-gray-400">
            Purchase Credits to use BuddyBot
          </p>
        </div>
      </div>
